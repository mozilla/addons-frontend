...
import type { ExternalUserType, NotificationType, NotificationsType, NotificationsUpdateType, UserEditableFieldsType, UserId } from 'amo/reducers/users';
...
export type UpdateUserAccountParams = UserApiParams & UserEditableFieldsType & {
  picture?: File | null;
};
...
export type UpdateUserNotificationsParams = UserApiParams & {
