...
export const minimalReduxLogger = (): (next: (action: Record<string, any>) => Record<string, any>) => (action: Record<string, any>) => Record<string, any> => (next: (action: Record<string, any>) => Record<string, any>) => (action: Record<string, any>) => {
...
export function middleware({
  ...
  sagaMiddleware?: Record<string, any> | null;
  routerMiddleware?: Record<string, any> | null;
} = {}): any[] {
...
export const includeDevTools = ({
  ...
  _config?: typeof config;
} = {}): boolean => _config.get('enableDevTools');
export default function createStore({
  history = createMemoryHistory(),
  initialState = {},
}: CreateStoreParams = {}): {
  connectedHistory: Record<string, any>;
  sagaMiddleware: Record<string, any>;
