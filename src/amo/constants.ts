...
export const REVIEW_FLAG_REASON_SPAM: 'review_flag_reason_spam' = 'review_flag_reason_spam';
export const REVIEW_FLAG_REASON_LANGUAGE: 'review_flag_reason_language' = 'review_flag_reason_language';
export const REVIEW_FLAG_REASON_BUG_SUPPORT: 'review_flag_reason_bug_support' = 'review_flag_reason_bug_support';
export const REVIEW_FLAG_REASON_OTHER: 'review_flag_reason_other' = 'review_flag_reason_other';
export type FlagReviewReasonType = typeof REVIEW_FLAG_REASON_SPAM | typeof REVIEW_FLAG_REASON_LANGUAGE | typeof REVIEW_FLAG_REASON_BUG_SUPPORT | typeof REVIEW_FLAG_REASON_OTHER;
...
export const DOWNLOAD_FIREFOX_BASE_URL = 'https://www.mozilla.org/firefox/download/thanks/';
export const PROMOTED_ADDONS_SUMO_URL = 'https://support.mozilla.org/kb/add-on-badges';
// Addon States.
...
export const validInstallStates = [DISABLED, DISABLING, DOWNLOADING, ENABLED, ENABLING, ERROR, INACTIVE, INSTALLED, INSTALLING, UNINSTALLED, UNINSTALLING, UNKNOWN];
// Add-on error states.
...
export type AddonTypeType = typeof ADDON_TYPE_DICT | typeof ADDON_TYPE_EXTENSION | typeof ADDON_TYPE_LANG | typeof ADDON_TYPE_STATIC_THEME;
export const validAddonTypes = [ADDON_TYPE_DICT, ADDON_TYPE_EXTENSION, ADDON_TYPE_LANG, ADDON_TYPE_STATIC_THEME];
...
export const VISIBLE_ADDON_TYPES_MAPPING: Record<string, string> = // $FlowIgnore: Flow can't be sure that the reduce result is a string.
Object.keys(API_ADDON_TYPES_MAPPING).reduce((object, key: string) => ({ ...object,
...
export const INCOMPATIBLE_UNSUPPORTED_PLATFORM = 'INCOMPATIBLE_UNSUPPORTED_PLATFORM';
export const INCOMPATIBLE_NON_RESTARTLESS_ADDON = 'INCOMPATIBLE_NON_RESTARTLESS_ADDON';
export const INCOMPATIBLE_ANDROID_UNSUPPORTED = 'INCOMPATIBLE_ANDROID_UNSUPPORTED';
...
export const INSTALL_SOURCE_FEATURED_COLLECTION = 'homepage-collection-featured';
...
export const INSTALL_EVENT_LIST = ['onDownloadStarted', 'onDownloadProgress', 'onDownloadEnded', 'onDownloadCancelled', 'onDownloadFailed', 'onInstallStarted', 'onInstallProgress', 'onInstallEnded', 'onInstallCancelled', 'onInstallFailed'];
// Install Types
...
export const INSTALL_CANCELLED_EXTENSION_CATEGORY = 'AMO Addon Installs Cancelled';
export const INSTALL_CANCELLED_THEME_CATEGORY = 'AMO Theme Installs Cancelled';
export const INSTALL_DOWNLOAD_FAILED_EXTENSION_CATEGORY = 'AMO Addon Installs Download Failed';
export const INSTALL_DOWNLOAD_FAILED_THEME_CATEGORY = 'AMO Theme Installs Download Failed';
...
export const GLOBAL_EVENTS: Array<$Keys<typeof GLOBAL_EVENT_STATUS_MAP>> = Object.keys(GLOBAL_EVENT_STATUS_MAP);
// Generic error codes.
...
export const API_ERRORS_SESSION_EXPIRY = [API_ERROR_AUTHENTICATION_EXPIRED, API_ERROR_DECODING_SIGNATURE, API_ERROR_SIGNATURE_EXPIRED];
...
export const ALL_PROMOTED_CATEGORIES = [LINE, RECOMMENDED, SPONSORED, SPOTLIGHT, STRATEGIC, VERIFIED];
export const BADGE_CATEGORIES = [LINE, RECOMMENDED, VERIFIED];
export const EXCLUDE_WARNING_CATEGORIES = [LINE, RECOMMENDED, SPONSORED, SPOTLIGHT, VERIFIED];
export const REVIEWED_FILTER = 'badged';
export const VERIFIED_FILTER = `${SPONSORED},${VERIFIED}`;
export type PromotedCategoryType = typeof LINE | typeof RECOMMENDED | typeof SPONSORED | typeof SPOTLIGHT | typeof STRATEGIC | typeof VERIFIED;
