        ...
        <>
          <div id="about">
            ...
            <p // eslint-disable-next-line react/no-danger
              dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`If you are looking for add-ons for Thunderbird or SeaMonkey, please visit
                  %(startTBLink)saddons.thunderbird.net%(endTBLink)s or
                  %(startSMLink)saddons.thunderbird.net/seamonkey%(endSMLink)s.`), {
            startTBLink: '<a href="https://addons.thunderbird.net/thunderbird/">',
            endTBLink: '</a>',
            startSMLink: '<a href="https://addons.thunderbird.net/seamonkey/">',
            endSMLink: '</a>',
          }), ['a'])}
            />
          </div>
          ...
          <section>
            ...
            <ul>
              <li // eslint-disable-next-line react/no-danger
                dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`%(startLink)sMake your own add-on%(endLink)s.
                        We provide free hosting and update services and can help you
                        reach a large audience of users.`), {
              startLink: '<a href="https://addons.mozilla.org/developers/">',
              endLink: '</a>',
            }), ['a'])}
              />
              <li // eslint-disable-next-line react/no-danger
                dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`Help improve this website. It's open source, and you
              ...
              />
              <li // eslint-disable-next-line react/no-danger
                dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`Want to interact with addons.mozilla.org
              ...
              startAddonsServerDocumentation: '<a href="https://addons-server.readthedocs.io/en/latest/index.html">',
              endAddonsServerDocumentation: '</a>',
              startAddonsManager: '<a href="https://blog.mozilla.org/firefox/add-ons-manager/">',
              endAddonsManager: '</a>',
            }), ['a'])}
              />
            </ul>
            ...
            <ul>
              <li // eslint-disable-next-line react/no-danger
                dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`Participate in our %(startLink)sforum%(endLink)s.`), {
              startLink: '<a href="https://discourse.mozilla-community.org/c/add-ons">',
              endLink: '</a>',
            }), ['a'])}
              />
              <li>
            ...
            <p // eslint-disable-next-line react/no-danger
              dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`To see more ways you can contribute to the add-on community, please visit our %(startLink)swiki%(endLink)s.`), {
          ...
          <section>
            ...
            <p // eslint-disable-next-line react/no-danger
              dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`If you find a problem with the site, we'd love to fix it.
                   Please file an %(startIssueLink)sissue%(endIssueLink)s and include as much
                    detail as possible.`), {
            startIssueLink: '<a href="https://github.com/mozilla/addons/issues/new">',
            endIssueLink: '</a>',
          }), ['a'])}
            />
            <p // eslint-disable-next-line react/no-danger
              dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`To report a security vulnerability for an extension, even if it is not
            ...
            startSecIssueLink: '<a href="https://bugzilla.mozilla.org/enter_bug.cgi?product=addons.mozilla.org&component=Add-on%20Security&maketemplate=Add-on%20Security%20Bug&bit-23=1&rep_platform=All&op_sys=All" rel="nofollow">',
            endSecIssueLink: '</a>',
            startMailLink: '<a href="mailto:amo-admins@mozilla.com">',
            endMailLink: '</a>',
            startLink: '<a href="https://www.mozilla.org/en-US/about/governance/policies/security-group/bugs/" rel="nofollow">',
            endLink: '</a>',
          }), ['a'])}
            />
          </section>
          <section>
            ...
            <p // eslint-disable-next-line react/no-danger
              dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`If you would like to learn more about how to manage add-ons in
            ...
            />
            <p // eslint-disable-next-line react/no-danger
              dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`%(startLink)sInformation about how to contact Mozilla's add-ons team can be found here%(endLink)s.`), {
...
export default (translate()(AboutBase) as React.ComponentType<Props>);