    ...
    return <footer className="Footer">
        <div className="Footer-wrapper">
          <div className="Footer-mozilla-link-wrapper">
            <a className="Footer-mozilla-link" href="https://mozilla.org/" title={homepageText}>
              <Icon alt={homepageText} className="Footer-mozilla-logo" name="mozilla" />
            </a>
          </div>
            ...
            <ul className="Footer-links">
              ...
              <li>
                <a
                  ...
                  href={`${_config.get('extensionWorkshopUrl')}/documentation/publish/add-on-policies/${makeQueryStringWithUTM({
              ...
              <li>
                <a className="Footer-bug-report-link" href="https://developer.mozilla.org/docs/Mozilla/Add-ons/Contact_us">
          ...
          <ul className="Footer-legal-links">
            <li>
              <a className="Footer-privacy-link" href="https://www.mozilla.org/privacy/websites/">
                {i18n.gettext('Privacy')}
              </a>
            </li>
            <li>
              <a className="Footer-cookies-link" href="https://www.mozilla.org/privacy/websites/">
                {i18n.gettext('Cookies')}
              </a>
            </li>
            <li>
              <a className="Footer-legal-link" href="https://www.mozilla.org/about/legal/terms/mozilla/">
                {i18n.gettext('Legal')}
              </a>
            </li>
          </ul>
          ...
          <p
            className="Footer-copyright" // eslint-disable-next-line react/no-danger
            dangerouslySetInnerHTML={sanitizeHTML(i18n.sprintf(i18n.gettext(`Except where otherwise %(startNotedLink)snoted%(endNotedLink)s,
          ...
          {!noLangPicker && <div className="Footer-language-picker">
              <LanguagePicker />
            </div>}
        </div>
      </footer>;
