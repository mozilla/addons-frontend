...
type Props = DefaultProps & {
  ...
  className?: string;
  confirmButtonText?: $PropertyType<ConfirmationDialogProps, 'confirmButtonText'>;
  confirmButtonType?: $PropertyType<ConfirmationDialogProps, 'confirmButtonType'>;
  id: string;
...
export class ConfirmButtonBase extends React.Component<InternalProps> {
  ...
  render(): React.ReactNode {
    ...
    return <div className={classNames}>
        {showConfirmation ? <ConfirmationDialog cancelButtonText={cancelButtonText} cancelButtonType={cancelButtonType} confirmButtonText={confirmButtonText} confirmButtonType={confirmButtonType} onCancel={this.toggleConfirmation} onConfirm={this.onConfirm} message={message} puffyButtons={puffyButtons} /> : <Button buttonType={buttonType} htmlType={htmlType} className="ConfirmButton-default-button" onClick={this.toggleConfirmation}>
            {children}
          </Button>}
      </div>;
  }
...
const ConfirmButton: React.ComponentType<Props> = compose(withUIState({
  fileName: __filename,
  extractId,
