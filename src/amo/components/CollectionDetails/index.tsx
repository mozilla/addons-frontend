...
import { beginEditingCollectionDetails, collectionEditUrl, collectionName, collectionUrl, convertFiltersToQueryParams } from 'amo/reducers/collections';
...
export class CollectionDetailsBase extends React.Component<InternalProps> {
  ...
  render(): React.ReactNode {
    ...
    return <div className="CollectionDetails">
        ...
        content: collection ? i18n.moment(collection.lastUpdatedDate).format('ll') : null,
        title: i18n.gettext('Last updated'),
      }]}
        />
        {collection && showEditButton && !editing && <Button
          buttonType="neutral"
          className="CollectionDetails-edit-button"
          puffy
          to={{
        pathname: collectionEditUrl({
          collection,
        }),
        ...
        {collection && editing && hasEditPermission && <Button buttonType="neutral" className="CollectionDetails-edit-details-button" puffy href="#editdetails" onClick={this.onEditDetails}>
            {i18n.gettext('Edit collection details')}
          </Button>}
        {collection && editing && <Button
          buttonType="cancel"
...
const CollectionDetails: React.ComponentType<Props> = compose(translate(), connect())(CollectionDetailsBase);
