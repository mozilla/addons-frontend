...
export const getErrorComponent = (status: number | null): () => React.ReactNode => {
  switch (status) {
    case 401:
...
const ErrorPage: React.ComponentType<Props> = compose(connect(mapStateToProps))(ErrorPageBase);
