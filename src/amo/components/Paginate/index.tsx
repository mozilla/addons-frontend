    ...
    return (
      ...
      <div className="Paginate">
        <div className="Paginate-links">
          <PaginatorLink {...linkParams} className="Paginate-item--previous" page={thisPage - 1} pageParam={pageParam} text={i18n.gettext('Previous')} />

          {getVisiblePages({
            currentPage,
            pageCount,
            showPages,
          }).map((page) => <PaginatorLink {...linkParams} key={`page-${page}`} page={page} pageParam={pageParam} />)}

          <PaginatorLink {...linkParams} className="Paginate-item--next" page={thisPage + 1} pageParam={pageParam} text={i18n.gettext('Next')} />
        </div>
