...
export class NotFoundBase extends React.Component<InternalProps> {
  render(): React.ReactNode {
    ...
    const paragraphWithLinks = replaceStringsWithJSX({
      text: i18n.gettext(`Try visiting the page later, as the theme or extension may become
    ...
    return <ErrorComponent code={404} header={i18n.gettext('Oops! We can’t find that page')}>
        <p>
