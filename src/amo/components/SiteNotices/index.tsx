...
export class SiteNoticesBase extends React.Component<InternalProps> {
  render(): Array<React.ReactNode> {
    ...
    if (siteNotice) {
      notices.push(<Notice className="SiteNotices" id="amo-site-notice" type="warning" key="amo-site-notice">
    ...
    if (siteIsReadOnly) {
      notices.push(<Notice className="SiteNotices" id="amo-site-read-only" type="warning" key="amo-site-read-only">
    ...
    if (currentUserWasLoggedOut) {
      notices.push(<Notice className="SiteNotices" id="user-was-logged-out" type="warning" key="user-was-logged-out">
...
export default (compose(connect(mapStateToProps), translate())(SiteNoticesBase) as React.ComponentType<Props>);