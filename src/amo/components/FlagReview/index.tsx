...
export class FlagReviewBase extends React.Component<InternalProps> {
  ...
  renderControls(): React.ReactNode {
    ...
    return <button className="FlagReview-button" onClick={this.onClick} type="button">
        {buttonText}
      </button>;
  }
...
const FlagReview: React.ComponentType<Props> = compose(connect(mapStateToProps), withErrorHandler({
  name: 'FlagReview',
  extractId,
}))(FlagReviewBase);
