...
export class OverlayBase extends React.Component<InternalProps> {
  ...
  componentDidUpdate({
    ...
    const {
      visibleOnLoad: visibleOnLoadNew,
      keydown: escKeydown,
    } = this.props;
    ...
    if (visibleOnLoadNew !== undefined && visibleOnLoadNew !== uiState.visible) {
      this.props.setUIState({
        visible: visibleOnLoadNew,
      });
    }
  }
  ...
  render(): React.ReactNode {
    ...
    >
        <div className="Overlay-background" onClick={this.onClickBackground} role="presentation" />
...
const Overlay: React.ComponentType<Props> = compose(withUIState({
  fileName: __filename,
  extractId,
  initialState: initialUIState,
}), keydown(ESC))(OverlayBase);
