...
export default class Card extends React.Component {
  ...
  render() {
    ...
    if (footerText && footerLink || footerLink && footerNode || footerText && footerNode) {
    ...
    >
        ...
        >
            ...
            {isHomepageShelf && footer ? <footer className="Card-shelf-footer-in-header">{footer}</footer> : null}
          </header> : null}
