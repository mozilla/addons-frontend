...
import { ADDON_TYPE_EXTENSION, ADDON_TYPE_STATIC_THEME, CLIENT_APP_ANDROID, CLIENT_APP_FIREFOX, VIEW_CONTEXT_LANGUAGE_TOOLS } from 'amo/constants';
...
export class SectionLinksBase extends React.Component<InternalProps> {
  ...
  render(): React.ReactNode {
    ...
    invariant(clientApp === CLIENT_APP_FIREFOX, 'SectionLinks included when clientApp is not Firefox');
    const linkProps = {
      prependClientApp: !forBlog,
      prependLang: !forBlog,
    };
    return <ul className={makeClassName('SectionLinks', className)}>
        <li>
          <Link
            className={makeClassName('SectionLinks-link', 'SectionLinks-link-extension', {
        ...
        <li>
          <Link
            className={makeClassName('SectionLinks-link', 'SectionLinks-link-theme', {
        ...
        <li>
          <DropdownMenu className="SectionLinks-link SectionLinks-dropdown" text={i18n.gettext('More…')}>
            <>
              ...
              <DropdownMenuItem key="dictionaries-and-language-packs">
                ...
                'SectionLinks-dropdownlink--active': viewContext === VIEW_CONTEXT_LANGUAGE_TOOLS,
              })}
                  to="/language-tools/"
                >
              ...
              <DropdownMenuItem>
                <Link className={`SectionLinks-clientApp-${CLIENT_APP_ANDROID}`} data-clientapp={CLIENT_APP_ANDROID} onClick={this.setClientApp} prependClientApp={false} to={`/${CLIENT_APP_ANDROID}/`}>
...
const SectionLinks: React.ComponentType<Props> = compose(withRouter, connect(mapStateToProps), translate())(SectionLinksBase);
