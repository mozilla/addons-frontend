...
const IconXMark = ({
  ...
  return <Icon {...iconProps} className={makeClassName('IconXMark', className)} name="inline-content">
      <svg className="IconXMark-svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <g className="IconXMark-path" transform="translate(-1.000000, -1.000000)" fill="#0C0C0D">
