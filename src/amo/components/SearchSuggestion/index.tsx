...
export const SearchSuggestionBase = ({
  ...
  return <p className={makeClassName('SearchSuggestion', `SearchSuggestion--${type}`)}>
      ...
      {promotedCategory ? <IconPromotedBadge category={promotedCategory} className="SearchSuggestion-icon-promoted" showAlt size="small" /> : null}
      <Icon alt={arrowAlt} className="SearchSuggestion-icon-arrow" name="arrow-blue" />
    </p>;
};
...
const SearchSuggestion: React.ComponentType<Props> = compose(connect(mapStateToProps))(SearchSuggestionBase);
