...
export class HostPermissionsBase extends React.Component<InternalProps> {
  getPermissionString({
    ...
    switch (messageType) {
      ...
      case domainMessageType:
        return i18n.sprintf(i18n.gettext('Access your data for sites in the %(param)s domain'), {
          param,
        });
      ...
      default:
        throw new Error(`No matching string found for messageType: ${messageType}`);
    }
  }
  ...
  generateHostPermissions({
    permissions,
    messageType,
  }: GenerateHostPermissionsParams): Array<React.ReactNode> {
...
const HostPermissions: React.ComponentType<Props> = compose(translate())(HostPermissionsBase);
