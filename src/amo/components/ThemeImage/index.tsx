...
export const ThemeImageBase = ({
  ...
  invariant(addon && ADDON_TYPE_STATIC_THEME === addon.type, 'A ThemeImage can only be rendered for a static theme');
  ...
  return <div
    ...
    role="presentation"
  >
      <img alt={label} className="ThemeImage-image" src={getPreviewImage(addon)} />
    </div>;
};
