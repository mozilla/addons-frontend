...
import config from 'config'; // This is a webpack plugin to expose the data generated by SriPlugin.
    ...
    compiler.hooks.done.tap('SriDataPlugin', (stats) => {
      ...
      try {
        assets.forEach((asset) => {
          ...
          if (!asset.integrity && (name.endsWith('.css') || name.endsWith('.js'))) {
            throw new Error(oneLine`The integrity property is falsey for asset ${name}; Is
