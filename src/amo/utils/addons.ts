...
import { BADGE_CATEGORIES, DOWNLOAD_FAILED, ERROR_CORRUPT_FILE, FATAL_ERROR, FATAL_INSTALL_ERROR, FATAL_UNINSTALL_ERROR, INSTALL_FAILED, SPONSORED, VERIFIED } from 'amo/constants';
...
export const getErrorMessage = ({
  ...
  switch (error) {
    case ERROR_CORRUPT_FILE:
      return i18n.gettext('Installation aborted because the add-on appears to be corrupt.');
