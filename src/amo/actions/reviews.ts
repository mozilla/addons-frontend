...
import type { ExternalReviewReplyType, ExternalReviewType } from 'amo/api/reviews';
import type { UserId } from 'amo/reducers/users';

export const CREATE_ADDON_REVIEW: 'CREATE_ADDON_REVIEW' = 'CREATE_ADDON_REVIEW';
export const SHOW_EDIT_REVIEW_FORM: 'SHOW_EDIT_REVIEW_FORM' = 'SHOW_EDIT_REVIEW_FORM';
export const SHOW_REPLY_TO_REVIEW_FORM: 'SHOW_REPLY_TO_REVIEW_FORM' = 'SHOW_REPLY_TO_REVIEW_FORM';
export const FETCH_REVIEW: 'FETCH_REVIEW' = 'FETCH_REVIEW';
export const FETCH_REVIEW_PERMISSIONS: 'FETCH_REVIEW_PERMISSIONS' = 'FETCH_REVIEW_PERMISSIONS';
export const FETCH_REVIEWS: 'FETCH_REVIEWS' = 'FETCH_REVIEWS';
export const FETCH_LATEST_USER_REVIEW: 'FETCH_LATEST_USER_REVIEW' = 'FETCH_LATEST_USER_REVIEW';
export const FETCH_USER_REVIEWS: 'FETCH_USER_REVIEWS' = 'FETCH_USER_REVIEWS';
export const FLASH_REVIEW_MESSAGE: 'FLASH_REVIEW_MESSAGE' = 'FLASH_REVIEW_MESSAGE';
export const HIDE_FLASHED_REVIEW_MESSAGE: 'HIDE_FLASHED_REVIEW_MESSAGE' = 'HIDE_FLASHED_REVIEW_MESSAGE';
export const HIDE_EDIT_REVIEW_FORM: 'HIDE_EDIT_REVIEW_FORM' = 'HIDE_EDIT_REVIEW_FORM';
export const HIDE_REPLY_TO_REVIEW_FORM: 'HIDE_REPLY_TO_REVIEW_FORM' = 'HIDE_REPLY_TO_REVIEW_FORM';
...
export const SET_REVIEW_PERMISSIONS: 'SET_REVIEW_PERMISSIONS' = 'SET_REVIEW_PERMISSIONS';
export const SET_REVIEW_REPLY: 'SET_REVIEW_REPLY' = 'SET_REVIEW_REPLY';
export const SET_REVIEW_WAS_FLAGGED: 'SET_REVIEW_WAS_FLAGGED' = 'SET_REVIEW_WAS_FLAGGED';
export const SEND_REPLY_TO_REVIEW: 'SEND_REPLY_TO_REVIEW' = 'SEND_REPLY_TO_REVIEW';
...
export const BEGIN_DELETE_ADDON_REVIEW: 'BEGIN_DELETE_ADDON_REVIEW' = 'BEGIN_DELETE_ADDON_REVIEW';
export const CANCEL_DELETE_ADDON_REVIEW: 'CANCEL_DELETE_ADDON_REVIEW' = 'CANCEL_DELETE_ADDON_REVIEW';
export const UNLOAD_ADDON_REVIEWS: 'UNLOAD_ADDON_REVIEWS' = 'UNLOAD_ADDON_REVIEWS';
export const UPDATE_RATING_COUNTS: 'UPDATE_RATING_COUNTS' = 'UPDATE_RATING_COUNTS';
...
export function createInternalReview(review: ExternalReviewType | ExternalReviewReplyType): UserReviewType {
  return {
    reviewAddon: {
...
export function setReviewPermissions({
  ...
  invariant(addonId, 'addonId is required');
  invariant(userId, 'userId is required');
  invariant(typeof canReplyToReviews !== 'undefined', 'canReplyToReviews is required');
  return {
...
export const setUserReviews = ({
  ...
  invariant(Array.isArray(reviews), 'reviews are required and must be an array');
  invariant(userId, 'userId is required');
  return {
...
export const setInternalReview = (review: UserReviewType): SetInternalReviewAction => {
  if (!review) {
    throw new Error('review cannot be empty');
  }

  return {
    type: SET_INTERNAL_REVIEW,
    payload: review,
  };
};
...
export const showEditReviewForm = ({
  ...
  return reviewIdAction({
    type: SHOW_EDIT_REVIEW_FORM,
    reviewId,
  });
};
...
export const showReplyToReviewForm = ({
  ...
  return reviewIdAction({
    type: SHOW_REPLY_TO_REVIEW_FORM,
    reviewId,
  });
};
...
export const hideReplyToReviewForm = ({
  ...
  return reviewIdAction({
    type: HIDE_REPLY_TO_REVIEW_FORM,
    reviewId,
  });
};
...
export type FlashMessageType = typeof ABORTED | typeof SAVED_RATING | typeof SAVED_REVIEW | typeof STARTED_SAVE_RATING | typeof STARTED_SAVE_REVIEW;
...
export const flashReviewMessage = (message: FlashMessageType): FlashReviewMessageAction => {
