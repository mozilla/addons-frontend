...
export function getHeroItems(i18n: I18nType) {
  return [
    {
    ...
    },
    {
      ...
      description: i18n.gettext('Adjust video playback speeds with shortcuts'),
    ...
    },
    {
      ...
      description: i18n.gettext('Add Britannica facts to your search results'),
