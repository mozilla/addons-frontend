...
export const ADD_ADDON_TO_COLLECTION: 'ADD_ADDON_TO_COLLECTION' = 'ADD_ADDON_TO_COLLECTION';
export const FETCH_CURRENT_COLLECTION: 'FETCH_CURRENT_COLLECTION' = 'FETCH_CURRENT_COLLECTION';
export const FETCH_USER_COLLECTIONS: 'FETCH_USER_COLLECTIONS' = 'FETCH_USER_COLLECTIONS';
export const LOAD_CURRENT_COLLECTION: 'LOAD_CURRENT_COLLECTION' = 'LOAD_CURRENT_COLLECTION';
export const FETCH_CURRENT_COLLECTION_PAGE: 'FETCH_CURRENT_COLLECTION_PAGE' = 'FETCH_CURRENT_COLLECTION_PAGE';
export const LOAD_CURRENT_COLLECTION_PAGE: 'LOAD_CURRENT_COLLECTION_PAGE' = 'LOAD_CURRENT_COLLECTION_PAGE';
export const ABORT_FETCH_CURRENT_COLLECTION: 'ABORT_FETCH_CURRENT_COLLECTION' = 'ABORT_FETCH_CURRENT_COLLECTION';
export const ABORT_FETCH_USER_COLLECTIONS: 'ABORT_FETCH_USER_COLLECTIONS' = 'ABORT_FETCH_USER_COLLECTIONS';
export const ABORT_ADD_ADDON_TO_COLLECTION: 'ABORT_ADD_ADDON_TO_COLLECTION' = 'ABORT_ADD_ADDON_TO_COLLECTION';
export const LOAD_USER_COLLECTIONS: 'LOAD_USER_COLLECTIONS' = 'LOAD_USER_COLLECTIONS';
export const ADDON_ADDED_TO_COLLECTION: 'ADDON_ADDED_TO_COLLECTION' = 'ADDON_ADDED_TO_COLLECTION';
export const LOAD_COLLECTION_ADDONS: 'LOAD_COLLECTION_ADDONS' = 'LOAD_COLLECTION_ADDONS';
export const UPDATE_COLLECTION: 'UPDATE_COLLECTION' = 'UPDATE_COLLECTION';
export const UNLOAD_COLLECTION_BY_SLUG: 'UNLOAD_COLLECTION_BY_SLUG' = 'UNLOAD_COLLECTION_BY_SLUG';
export const CREATE_COLLECTION: 'CREATE_COLLECTION' = 'CREATE_COLLECTION';
export const BEGIN_COLLECTION_MODIFICATION: 'BEGIN_COLLECTION_MODIFICATION' = 'BEGIN_COLLECTION_MODIFICATION';
export const FINISH_COLLECTION_MODIFICATION: 'FINISH_COLLECTION_MODIFICATION' = 'FINISH_COLLECTION_MODIFICATION';
export const REMOVE_ADDON_FROM_COLLECTION: 'REMOVE_ADDON_FROM_COLLECTION' = 'REMOVE_ADDON_FROM_COLLECTION';
export const ADDON_REMOVED_FROM_COLLECTION: 'ADDON_REMOVED_FROM_COLLECTION' = 'ADDON_REMOVED_FROM_COLLECTION';
export const DELETE_COLLECTION: 'DELETE_COLLECTION' = 'DELETE_COLLECTION';
export const UPDATE_COLLECTION_ADDON: 'UPDATE_COLLECTION_ADDON' = 'UPDATE_COLLECTION_ADDON';
export const DELETE_COLLECTION_ADDON_NOTES: 'DELETE_COLLECTION_ADDON_NOTES' = 'DELETE_COLLECTION_ADDON_NOTES';
export const BEGIN_EDITING_COLLECTION_DETAILS: 'BEGIN_EDITING_COLLECTION_DETAILS' = 'BEGIN_EDITING_COLLECTION_DETAILS';
export const FINISH_EDITING_COLLECTION_DETAILS: 'FINISH_EDITING_COLLECTION_DETAILS' = 'FINISH_EDITING_COLLECTION_DETAILS';
...
export const abortFetchCurrentCollection = (): AbortFetchCurrentCollection => {
  return {
    type: ABORT_FETCH_CURRENT_COLLECTION,
  };
};
...
type CreateCollectionParams = RequiredModifyCollectionParams & OptionalModifyCollectionParams & {
  includeAddonId?: number;
  name: LocalizedString;
  slug: string;
};
type UpdateCollectionParams = RequiredModifyCollectionParams & OptionalModifyCollectionParams & {
...
export const unloadCollectionBySlug = (slug: string): UnloadCollectionBySlugAction => {
  if (!slug) {
...
export const updateCollectionAddon = ({
  ...
  invariant(addonId, 'The addonId parameter is required');
  invariant(errorHandlerId, 'The errorHandlerId parameter is required');
  invariant(notes !== undefined && notes !== null, 'The notes parameter is required');
  invariant(filters, 'The filters parameter is required');
  invariant(slug, 'The slug parameter is required');
  invariant(userId, 'The userId parameter is required');
  return {
...
export const createInternalAddons = (items: ExternalCollectionAddons, lang: string): Array<CollectionAddonType> => {
  return items.map(({
    addon,
    notes,
  }) => {
...
export const getCurrentCollection = (collectionsState: CollectionsState): CollectionType | null => {
  if (!collectionsState) {
...
export const createInternalCollection = ({
  ...
  addons: addonsResponse ? createInternalAddons(addonsResponse.results, lang) : null,
...
export const changeAddonCollectionsLoadingFlag = ({
  ...
  return { ...state,
    addonInCollections: { ...state.addonInCollections,
      [userId]: { ...userState,
        [addonId]: {
...
export const expandCollections = (collections: CollectionsState, meta?: {
  collections: Array<CollectionId> | null;
}): Array<CollectionType> | null => {
  return meta && meta.collections ? meta.collections.reduce((result, id) => {
...
export const convertFiltersToQueryParams = (filters: CollectionFilters): QueryParams => {
  return {
    page: filters.page,
...
type CollectionUrlParams = {
  ...
  collectionSlug?: string;
  _collectionUrl?: (...args: Array<any>) => any;
};
export const collectionUrl = ({
  ...
  invariant(slug && userId, 'Either a collection or an authorId and collectionSlug are required.');
...
type Action = AbortFetchCurrentCollection | AbortAddAddonToCollectionAction | AbortFetchUserCollectionsAction | AddAddonToCollectionAction | AddonAddedToCollectionAction | BeginCollectionModificationAction | CreateCollectionAction | DeleteCollectionAction | FetchCurrentCollectionAction | FetchCurrentCollectionPageAction | FetchUserCollectionsAction | FinishCollectionModificationAction | LoadCollectionAddonsAction | LoadCurrentCollectionAction | LoadCurrentCollectionPageAction | LoadUserCollectionsAction | UnloadCollectionBySlugAction | UpdateCollectionAction;

const reducer = (state: CollectionsState = initialState, action: Action): CollectionsState => {
  switch (action.type) {
    ...
    case FETCH_CURRENT_COLLECTION_PAGE:
      {
        ...
        return { ...state,
          byId: { ...state.byId,
            [currentCollection.id]: { ...currentCollection,
              addons: [],
              numberOfAddons: null,
              pageSize: null,
            },
    ...
    case LOAD_COLLECTION_ADDONS:
      {
        ...
        if (!collectionId) {
          throw new Error(oneLine`Cannot load add-ons for collection
    ...
    case ADDON_ADDED_TO_COLLECTION:
      {
        ...
        if (addonInCollections[userId] && addonInCollections[userId][addonId]) {
          const existingCollections = addonInCollections[userId][addonId].collections;
        ...
        return { ...state,
          addonInCollections: { ...state.addonInCollections,
            [userId]: { ...state.addonInCollections[userId],
              [addonId]: {
