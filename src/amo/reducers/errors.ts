...
import { ERROR_ADDON_DISABLED_BY_ADMIN, ERROR_ADDON_DISABLED_BY_DEV, ERROR_UNKNOWN } from 'amo/constants';
  ...
  reducers: {
    ...
    setError(state, action) {
      ...
      state[action.payload.id] = {
        code,
        messages,
        responseStatusCode: action.payload.error.response ? action.payload.error.response.status : null,
      };
    },
