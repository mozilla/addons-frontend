...
export const HIDE_ADDON_ABUSE_REPORT_UI: 'HIDE_ADDON_ABUSE_REPORT_UI' = 'HIDE_ADDON_ABUSE_REPORT_UI';
export const LOAD_ADDON_ABUSE_REPORT: 'LOAD_ADDON_ABUSE_REPORT' = 'LOAD_ADDON_ABUSE_REPORT';
export const SEND_ADDON_ABUSE_REPORT: 'SEND_ADDON_ABUSE_REPORT' = 'SEND_ADDON_ABUSE_REPORT';
export const SHOW_ADDON_ABUSE_REPORT_UI: 'SHOW_ADDON_ABUSE_REPORT_UI' = 'SHOW_ADDON_ABUSE_REPORT_UI';
export const INITIATE_ADDON_ABUSE_REPORT_VIA_FIREFOX: 'INITIATE_ADDON_ABUSE_REPORT_VIA_FIREFOX' = 'INITIATE_ADDON_ABUSE_REPORT_VIA_FIREFOX';
export const FINISH_ADDON_ABUSE_REPORT_VIA_FIREFOX: 'FINISH_ADDON_ABUSE_REPORT_VIA_FIREFOX' = 'FINISH_ADDON_ABUSE_REPORT_VIA_FIREFOX';
...
export type AbuseState = {
  bySlug: Record<string, AddonAbuseState>;
  loading: boolean;
};
...
type HideAddonAbuseReportUIParams = {
  addon: AddonType;
};
...
type ShowAddonAbuseReportUIParams = {
  addon: AddonType;
};
...
type Action = FinishAddonAbuseReportViaFirefoxAction | HideAddonAbuseReportUIAction | InitiateAddonAbuseReportViaFirefoxAction | LoadAddonAbuseReportAction | SendAddonAbuseReportAction | ShowAddonAbuseReportUIAction;
export default function abuseReducer(state: AbuseState = initialState, action: Action): AbuseState {
  switch (action.type) {
    case HIDE_ADDON_ABUSE_REPORT_UI:
      {
        ...
        return { ...state,
          bySlug: { ...state.bySlug,
            [addon.slug]: { ...state.bySlug[addon.slug],
              uiVisible: false,
            },
          },
        };
