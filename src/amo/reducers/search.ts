...
import type { AddonType, CollectionAddonType, ExternalAddonType } from 'amo/types/addons';
    ...
    case SEARCH_LOADED:
      {
        ...
        return { ...state,
          ...
          results: payload.results.map((addon) => createInternalAddon(addon, state.lang)),
        };
      }
