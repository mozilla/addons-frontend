...
export const ABORT_USER_ABUSE_REPORT: 'ABORT_USER_ABUSE_REPORT' = 'ABORT_USER_ABUSE_REPORT';
export const HIDE_USER_ABUSE_REPORT_UI: 'HIDE_USER_ABUSE_REPORT_UI' = 'HIDE_USER_ABUSE_REPORT_UI';
export const LOAD_USER_ABUSE_REPORT: 'LOAD_USER_ABUSE_REPORT' = 'LOAD_USER_ABUSE_REPORT';
export const SEND_USER_ABUSE_REPORT: 'SEND_USER_ABUSE_REPORT' = 'SEND_USER_ABUSE_REPORT';
export const SHOW_USER_ABUSE_REPORT_UI: 'SHOW_USER_ABUSE_REPORT_UI' = 'SHOW_USER_ABUSE_REPORT_UI';
...
export type UserAbuseReportsState = {
  byUserId: Record<UserId, UserAbuseReportState>;
};
export type UserAbuseReportActionType = AbortUserAbuseReportAction | HideUserAbuseReportUIAction | SendUserAbuseReportAction | ShowUserAbuseReportUIActions | LoadUserAbuseReportAction;
export const initialState: UserAbuseReportsState = {
  byUserId: {},
};
export default function userAbuseReportReducer(state: UserAbuseReportsState = initialState, action: UserAbuseReportActionType): UserAbuseReportsState {
  switch (action.type) {
