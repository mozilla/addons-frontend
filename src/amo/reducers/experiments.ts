export const STORE_EXPERIMENT_VARIANT: 'STORE_EXPERIMENT_VARIANT' = 'STORE_EXPERIMENT_VARIANT';
export type ExperimentsState = Record<string, string>;
...
export default function experimentsReducer(state: ExperimentsState = initialState, action: Action): ExperimentsState {
  switch (action.type) {
