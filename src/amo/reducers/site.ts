...
export const LOADED_PAGE_IS_ANONYMOUS: 'LOADED_PAGE_IS_ANONYMOUS' = 'LOADED_PAGE_IS_ANONYMOUS';
...
type Action = FetchSiteStatusAction | LoadSiteStatusAction | LoadedPageIsAnonymousAction;
export default function siteReducer(state: SiteState = initialState, action: Action): SiteState {
  switch (action.type) {
