...
export const HIGHLY_RATED_GET = 'HIGHLY_RATED_GET';
export const HIGHLY_RATED_LOADED = 'HIGHLY_RATED_LOADED';
export const HIGHLY_RATED_FAILED = 'HIGHLY_RATED_FAILED';
export const POPULAR_GET = 'POPULAR_GET';
