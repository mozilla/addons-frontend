...
export const StaticAddonCardBase = ({
  ...
  >
      {isTheme ? <div className="StaticAddonCard-theme-preview">
          <ThemeImage addon={addon} roundedCorners />
        </div> : <div className="StaticAddonCard-icon">
          <div className="StaticAddonCard-icon-wrapper">
            <img className="StaticAddonCard-icon-image" src={getAddonIconUrl(addon)} alt="" />
          </div>
        </div>}
...
const StaticAddonCard: React.ComponentType<Props> = translate()(StaticAddonCardBase);
