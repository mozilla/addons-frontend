module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "%(name)s is disabled. Click to enable.":[ "%(name)s ta deshabilitáu. Primi p'habilitar." ],
      "Uninstalling %(name)s.":[ "Desinstalando %(name)s." ],
      "%(name)s is uninstalled. Click to install.":[ "%(name)s ta desinstaláu. Primi pa instalar." ],
      ...
      "An unexpected error occurred during installation.":[ "Asocedió un fallu inesperáu na instalación." ],
      "An unexpected error occurred during uninstallation.":[ "Asocedió un fallu inesperáu na desinstalación." ],
      "An unexpected error occurred.":[ "Asocedió un fallu inesperáu." ],
