...
directory. You will need a license to run Sketch and you also need to
install some fonts (which are free). Install
[Fira Sans](https://www.fontsquirrel.com/fonts/fira-sans)
and [Chivo](https://www.fontsquirrel.com/fonts/chivo).
