...
The tests look for a URL of ```localhost:3000``` so it is also possible to just run ```yarn amo:dev``` without building the
image provided you have followed the correct setup.