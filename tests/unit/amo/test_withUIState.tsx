...
describe(__filename, () => {
  describe('withUIState', () => {
    ...
    class OverlayBase extends React.Component {
      ...
      render() {
        ...
        return <div className="overlay">
            <button className="close-button" onClick={this.closeOverlay} type="button">
              {buttonText}
            </button>
          </div>;
      }
    ...
    const render = ({
      ...
      defaultRender(<Overlay id={id} {...props} />, {
        store,
      });
    };
    ...
    it('does not reset state when unmounting', () => {
      ...
      const {
        unmount,
      } = defaultRender(<NonResettingOverlay id="some-component-id" />, {
        store,
      });
      dispatch.mockClear();
      unmount();
    ...
    it('can reset state when unmounting', () => {
      ...
      const {
        unmount,
      } = defaultRender(<AutoResettingOverlay id="some-component-id" />, {
        store,
      });
      unmount();
      expect(dispatch).toHaveBeenCalledWith(setUIState({
