...
import { createApiResponse, createFakeAddonAbuseReport, createFakeUserAbuseReport, createUserAccountResponse, dispatchClientMetadata, fakeAddon } from 'tests/unit/helpers';
...
describe(__filename, () => {
  ...
  describe('reportAddon', () => {
    function mockResponse({
      ...
      return createApiResponse({
        jsonData: createFakeAddonAbuseReport({
          addon,
          message,
        }),
      });
  ...
  describe('reportUser', () => {
    function mockResponse({
      ...
      return createApiResponse({
        jsonData: createFakeUserAbuseReport({
          message,
          user,
        }),
      });
