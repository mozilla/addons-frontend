import { SET_INTERNAL_REVIEW, createInternalReview, fetchReviews, flagReview, reviewIdAction, sendReplyToReview, setInternalReview, setReviewWasFlagged, setReviewReply } from 'amo/actions/reviews';
...
describe(__filename, () => {
  describe('fetchReviews', () => {
    ...
    it('requires a truthy add-on slug', () => {
      ...
      expect(() => fetchReviews(params)).toThrowError(/addonSlug cannot be empty/);
    });
    it('requires a truthy error handler ID', () => {
      const params = { ...defaultParams,
      };
      delete params.errorHandlerId;
      expect(() => fetchReviews(params)).toThrowError(/errorHandlerId cannot be empty/);
    });
    it('defaults to page 1', () => {
      const params = { ...defaultParams,
      };
      delete params.page;
      expect(fetchReviews(params)).toMatchObject({
        payload: {
          page: '1',
        },
      });
  ...
  describe('setReviewReply', () => {
    ...
    it('requires an originalReviewId', () => {
      ...
      expect(() => setReviewReply(params)).toThrow(/originalReviewId parameter is required/);
    });
    it('requires a reply', () => {
      const params = defaultParams();
      delete params.reply;
      expect(() => setReviewReply(params)).toThrow(/reply parameter is required/);
    });
  });
  ...
  describe('sendReplyToReview', () => {
    ...
    it('requires an errorHandlerId', () => {
      const params = defaultParams();
      delete params.errorHandlerId;
      expect(() => sendReplyToReview(params)).toThrow(/errorHandlerId parameter is required/);
    });
    it('requires an originalReviewId', () => {
      const params = defaultParams();
      delete params.originalReviewId;
      expect(() => sendReplyToReview(params)).toThrow(/originalReviewId parameter is required/);
    });
    it('requires a body', () => {
      const params = defaultParams();
      delete params.body;
      expect(() => sendReplyToReview(params)).toThrow(/body parameter is required/);
    });
  });
  ...
  describe('flagReview', () => {
    ...
    it('requires an errorHandlerId', () => {
      const params = defaultParams();
      delete params.errorHandlerId;
      expect(() => flagReview(params)).toThrow(/errorHandlerId parameter is required/);
    });
    ...
    it('requires a reviewId', () => {
      ...
      expect(() => flagReview(params)).toThrow(/reviewId parameter is required/);
    });
  });
  describe('setReviewWasFlagged', () => {
    ...
    it('requires a reason', () => {
      const params = defaultParams();
      delete params.reason;
      expect(() => setReviewWasFlagged(params)).toThrow(/reason parameter is required/);
    });
    it('requires a reviewId', () => {
      const params = defaultParams();
      delete params.reviewId;
      expect(() => setReviewWasFlagged(params)).toThrow(/reviewId parameter is required/);
    });
  });
});