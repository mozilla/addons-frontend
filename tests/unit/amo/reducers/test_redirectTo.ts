import redirectToReducer, { initialState, sendServerRedirect } from 'amo/reducers/redirectTo';
...
describe(__filename, () => {
  describe('reducer', () => {
    ...
    it('sets the server redirect information', () => {
      ...
      const state = redirectToReducer(undefined, sendServerRedirect(redirectTo));
