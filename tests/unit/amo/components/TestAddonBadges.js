...
describe(__filename, () => {
  ...
  it('displays a featured badge for a featured addon when the recommended feature is off', () => {
    const addon = createInternalAddon({
      ...fakeAddon,
      is_featured: true,
    });
  ...
  it('does not display a badge for a featured addon when the recommended feature is on', () => {
    const addon = createInternalAddon({
      ...fakeAddon,
      is_featured: true,
    });
