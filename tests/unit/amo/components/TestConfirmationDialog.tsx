...
describe(__filename, () => {
  ...
  it('calls onConfirm() when user clicks Confirm', async () => {
    ...
    await userEvent.click(screen.getByClassName('ConfirmationDialog-confirm-button'));
  ...
  it('calls onCancel() when user clicks Cancel', async () => {
    ...
    await userEvent.click(screen.getByClassName('ConfirmationDialog-cancel-button'));
