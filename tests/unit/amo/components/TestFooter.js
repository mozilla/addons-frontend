...
describe('Footer', () => {
  ...
  it('renders a footer', () => {
    ...
    expect(root.querySelector('.Footer-privacy').textContent).toEqual(
      'Privacy policy'
    );
    expect(root.querySelector('.Footer-privacy').href).toEqual(
      'https://www.mozilla.org/privacy/websites/'
    );
    expect(root.querySelector('.Footer-legal').textContent).toEqual(
      'Legal notices'
    );
    expect(root.querySelector('.Footer-legal').href).toEqual(
    ...
    expect(root.querySelector('.Footer-fileissue').href).toEqual(
