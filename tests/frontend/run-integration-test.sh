...
export UITEST_FXA_EMAIL=$(python ./tests/frontend/generate_fxa_email.py)
...
docker-compose -f addons-server/docker-compose.yml -f tests/frontend/docker-compose.selenium.yml exec selenium-firefox python3 -m pytest tests/frontend --driver Firefox -vv -m "serial"
docker-compose -f addons-server/docker-compose.yml -f tests/frontend/docker-compose.selenium.yml exec selenium-firefox python3 -m pytest tests/frontend --driver Firefox -vv -n 4 -m "not serial"
